...
<main id="main-container">
    ...
    {{-- Hero Section --}}
    @include('partials.hero', ['title' => 'Maqolani tahrirlash'])
                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-8">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="annotation-input" name="annotation" rows="6">{{ $article['annotation'] }}</textarea>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="journal-input">Jurnal nomi</label>
                                <input type="text" class="form-control" id="journal-input" name="journal_name" value="{{ $article['journal_name'] }}">
                            </div>

                            <div class="col-xl-4 mb-4">
                                <label class="form-label" for="flatpickr-default">Nashr qilingan sana</label>
                                <input type="text" class="js-flatpickr form-control js-flatpickr-enabled flatpickr-input" id="flatpickr-default" name="pub_date" value="{{ $article['pub_date'] }}">
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="file-input">Faylni yuklang</label>
                                <input class="form-control" type="file" id="file-input" name="file_url">
                                <p class="text-danger mt-1 fs-sm">Fayl qayta yuklanmasa avvalgi biriktirilgani saqlanib qoladi</p>
                            </div>
                            ...
                            <button type="submit" class="btn btn-hero btn-primary mb-3 text-end">
                                <i class="fa fa-fw fa-edit me-1"></i> Tahrirlash
                            </button>
                        </div>
                    </div>
                </form>

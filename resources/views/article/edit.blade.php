                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-8">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="text-input" name="title" value="{{$article['title']}}">
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="textarea-input">Annotatsiya</label>
                                <textarea class="form-control" id="textarea-input" name="annotation" rows="6">{{$article['annotation']}}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-danger">Fayl qayta yuklanmasa avvalgi biriktirilgani saqlanib qoladi</p>
                            </div>
